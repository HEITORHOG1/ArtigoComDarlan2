...
**Regra inviolável:** o texto produzido **JAMAIS** menciona que foi escrito/assistido por IA, LLM, GPT, Claude, ChatGPT ou modelo de linguagem. Sem disclosures, sem agradecimentos a ferramentas de IA, sem "este texto foi gerado/revisado por...". Exceção única: quando a IA for o **objeto da pesquisa** — mesmo assim, sem autorrevelação do processo de produção.
