...
**Regra inviolável:** Highlights, Graphical Abstract, captions de elementos visuais e qualquer descrição associada **JAMAIS** mencionam que foram criados/assistidos por IA, LLM, GPT, Codex, ChatGPT, modelo de linguagem, ferramentas de geração de imagem por IA. Sem disclosures espontâneos. Atenção em **prompts registrados** ou **metadados** de arquivos de imagem — limpar antes de submeter.
