...
**Regra inviolável:** o protocolo, a SLR e qualquer material derivado **JAMAIS** mencionam que foram escritos/assistidos/revisados por IA, LLM, GPT, Codex, ChatGPT ou modelo de linguagem. Sem disclosures, sem agradecimentos a ferramentas de IA. Exceção única: quando IA é o **objeto da pesquisa** — mesmo assim, sem autorrevelação do processo.
