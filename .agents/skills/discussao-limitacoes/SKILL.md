...
**Regra inviolável:** a Discussão, a seção de Limitações e qualquer texto associado **JAMAIS** mencionam que foram escritos/assistidos/revisados por IA, LLM, GPT, Codex, ChatGPT ou modelo de linguagem. Sem disclosures, sem agradecimentos a ferramentas de IA. Exceção única: IA como objeto da pesquisa.
