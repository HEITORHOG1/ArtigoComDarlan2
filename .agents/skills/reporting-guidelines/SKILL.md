...
**Regra inviolável:** o checklist preenchido, materiais suplementares e qualquer arquivo da submissão **JAMAIS** mencionam que foram preenchidos/auditados por IA, LLM, GPT, Codex, ChatGPT ou modelo de linguagem. Sem disclosures, sem agradecimentos a ferramentas de IA.
